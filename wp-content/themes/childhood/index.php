...
?>
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            <img src="<? the_field('about_img');?>" alt="про компанию">
                        </div>
                    </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                <h1 class="title"><? the_field('history_title', 2); ?></h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <? the_field('history_title_first', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <? the_field('history_descr_first', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<? the_field('history_img_first', 2); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<? the_field('history_img_second', 2); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <? the_field('history_title_second', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <? the_field('history_descr_second', 2); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <? the_field('history_title_third', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <? the_field('history_descr_third', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<? the_field('history_img_third', 2); ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<? the_field('tel_first', 2);  ?>"><? the_field('tel_first', 2);  ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<? the_field('tel_second', 2);  ?>"><? the_field('tel_second', 2);  ?></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <? echo do_shortcode('[contact-form-7 id="145" title="Форма отзывов"]');?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
